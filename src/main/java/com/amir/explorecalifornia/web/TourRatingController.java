package com.amir.explorecalifornia.web;

import com.amir.explorecalifornia.domain.Tour;
import com.amir.explorecalifornia.domain.TourRating;
import com.amir.explorecalifornia.domain.TourRatingPk;
import com.amir.explorecalifornia.repo.TourRatingRepository;
...
public class TourRatingController {
    ...
    public void createTourRating(@PathVariable("tourId") int tourId,@RequestBody @Validated RatingDto dto){
        Tour tour = verifyTour(tourId);
        tourRatingRepository.save(new TourRating(new TourRatingPk(tour,dto.getCustomerId()),dto.getScore(),
                dto.getComment()));
    }
    /**
